To use this code on your Pi, download as ZIP (or git clone if you wish) and extract. Next, open a Terminal and install Apache web server with PHP:
...
You must go into the code in index.html and change the 192.168.1.70 in index.html for your Pi's correct IP address. You may want to set a static ip address so it will not change in future: http://www.modmypi.com/blog/tutorial-how-to-give-your-raspberry-pi-a-static-ip-address
